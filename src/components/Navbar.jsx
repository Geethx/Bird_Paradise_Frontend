...
export default function Navbar() {
    ...
    return (
        <nav className="bg-white shadow-md p-4 flex justify-between items-center px-10">
            ...
            <Link to="/" className="text-2xl font-bold text-blue-800">BirdParadise 🌴</Link>
            
            <div className="flex items-center gap-6">
                {user ? (
                    <>
                        <Link to="/rooms" className="font-semibold text-gray-700 hover:text-blue-600 transition">Rooms</Link>
                        <Link to="/my-bookings" className="font-semibold text-gray-700 hover:text-blue-600 transition">My Bookings</Link>
                        <span className="font-medium text-blue-900 border-l-2 pl-4 border-gray-300">
                            Hello, {user.name}!
                        </span>
